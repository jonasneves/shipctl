                ...
                <div className="mx-auto w-full min-h-full flex flex-col space-y-6" style={{ maxWidth: '600px' }}>
                    ...
                    {messages.map((msg, idx) => {
                        ...
                        return (
                            ...
                            >
                                <div
                                    className={`group relative ${'max-w-[85%]'} rounded-2xl px-4 pt-3 pb-2 select-none transition-all cursor-pointer ${selectedMessages.has(idx)
